...
import org.ds.Calculator_Service;
...
public class Calculator extends HttpServlet {
    ...
    @WebServiceRef(wsdlLocation = "WEB-INF/wsdl/localhost_8080/CalculatorWS/Calculator.wsdl")
    ...
    private int add(int i, int j) {
        ...
        org.ds.Calculator port = service.getCalculatorPort();
        return port.add(i, j);
    }
